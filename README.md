...
<!-- badges: start -->
  ...
  [![DOI](https://img.shields.io/badge/DOI-10.32614%2FCRAN.package.CDatanet-blue)](https://doi.org/10.32614/CRAN.package.CDatanet)
...
**CDatanet** package includes all functions for the replication of the results in [Houndetoungan (2026)](https://arxiv.org/abs/2405.17290). The exact replication codes are located in the folder [**Results**](https://github.com/ahoundetoungan/CDatanet/tree/master/Results).
