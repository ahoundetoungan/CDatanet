...
```
### How to use CDatanet
I provide a [vignette](https://nbviewer.jupyter.org/github/ahoundetoungan/CDatanet/blob/master/doc/CDatanet_docx.pdf) that fully documents the package through simple and pratical examples. Moreover, each function of the package has a help page that may be accessed using `? name-of-the-function`. 