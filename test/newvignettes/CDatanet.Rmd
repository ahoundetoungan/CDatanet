...
delta  <- c(1, 0.87, 0.75, 0.6, 0.4) # delta
...
#  Count data
CD   <- CDnetNPL(formula = y ~ x1 + x2, contextual = TRUE, Glist = Glist, optimizer = "nlm", 
...
# SART
SART   <- SARTML(formula = y ~ x1 + x2, contextual = TRUE, Glist = Glist, RE = TRUE,
